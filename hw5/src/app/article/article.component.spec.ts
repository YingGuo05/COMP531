...
describe('ArticleComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
        ...
        providers:[ ShareService, NewArticleService,CommentService],
    })
    .compileComponents();
  }));
  ...
  it('should render articles', () => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(compiled.querySelector('.card').childNodes.length).toEqual(10)
    })
  })
  it('should dispatch actions to create new article', inject([NewArticleService], (service: NewArticleService) => {
    ...
    fixture.whenStable().then(() => {
      fixture.detectChanges();
      const compiled = fixture.debugElement.nativeElement;
      expect(compiled.querySelector('.card').childNodes.length).toEqual(4)
    })

...
cloudinary.config({ 
		cloud_name: 'djfotbsps', 
		api_key: '633672125983528', 
		api_secret: 'liHUyToqIB4lorVeHZMhnv0Cmu0' 
	  });
	
	if (!process.env.CLOUDINARY_URL) {
		process.env.CLOUDINARY_URL="cloudinary://163639515786445:SANEjrNwfROLI3Y17Bc_Vn4oBJY@hp8xmso7o"
	}
